...
func (o *PutBaremetalServerIDStateOK) WriteResponse(rw http.ResponseWriter, producer httpkit.Producer) {
...
// WriteResponse to the client
func (o *PutBaremetalServerIDStateDefault) WriteResponse(rw http.ResponseWriter, producer httpkit.Producer) {
