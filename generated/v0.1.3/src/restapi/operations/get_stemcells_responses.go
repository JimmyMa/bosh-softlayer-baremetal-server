...
func (o *GetStemcellsOK) WriteResponse(rw http.ResponseWriter, producer httpkit.Producer) {
...
// WriteResponse to the client
func (o *GetStemcellsDefault) WriteResponse(rw http.ResponseWriter, producer httpkit.Producer) {
