...
func (o *PutBaremetalsOK) WriteResponse(rw http.ResponseWriter, producer httpkit.Producer) {
...
// WriteResponse to the client
func (o *PutBaremetalsDefault) WriteResponse(rw http.ResponseWriter, producer httpkit.Producer) {
