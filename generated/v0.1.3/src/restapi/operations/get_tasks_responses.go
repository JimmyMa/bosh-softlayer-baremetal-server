...
func (o *GetTasksOK) WriteResponse(rw http.ResponseWriter, producer httpkit.Producer) {
...
// WriteResponse to the client
func (o *GetTasksDefault) WriteResponse(rw http.ResponseWriter, producer httpkit.Producer) {
