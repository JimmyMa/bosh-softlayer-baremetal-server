...
func (o *GetBmsDeploymentNameOK) WriteResponse(rw http.ResponseWriter, producer httpkit.Producer) {
...
// WriteResponse to the client
func (o *GetBmsDeploymentNameDefault) WriteResponse(rw http.ResponseWriter, producer httpkit.Producer) {
